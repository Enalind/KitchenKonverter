...
describe("Replacing US measurments",() => {
    ...
    test("Single element",() => {
        ...
        expect(result).toEqual("<div kitchen-converted=\"true\">2 and 2/5 dls</div>")
        ...
        expect(result).toEqual("<div kitchen-converted=\"true\">42 gs</div>")
        ...
        expect(result).toEqual("<div kitchen-converted=\"true\">1 and 2/5 ls</div>")
    })
    ...
    test("Unicode fractions", () => {
        ...
        let result = replacementWrapper(matchList, "us", "volume")
        expect(result).toEqual("<div kitchen-converted=\"true\">1 tbsp</div>")

        document.body.innerHTML = `<div>1½ cup</div>`
        matchList = [[document.querySelector("div"), ["1½ cup"]]]
        result = replacementWrapper(matchList, "us", "volume")
        expect(result).toEqual("<div kitchen-converted=\"true\">3 and 3/5 dls</div>")
    })
    ...
    test("Split element", () => {
        ...
        let matchList = [[document.querySelector("div"), ["1 cup"]]]
        let result = replacementWrapper(matchList, "us", "volume")
        expect(result).toEqual("<div><p kitchen-converted=\"true\">2 and 2/5 </p><h1 kitchen-converted=\"true\">dls</h1></div>")
    })
    ...
    test("Deeper node", () => {
        ...
        expect(result).toEqual("<div kitchen-converted=\"true\"><b>optional: </b>453 gs</div>")
    })
    ...
    test("Temperature",() => {
        ...
        expect(result).toEqual("<div kitchen-converted=\"true\">37 celsius</div>")
        ...
        expect(result).toEqual("<div kitchen-converted=\"true\">93 celsius</div>")
    })
...
describe("Replacing metric measurments",() => {
    ...
    test("Single element",() => {
        ...
        expect(result).toEqual("<div kitchen-converted=\"true\">3 and 1/3 fl ozs</div>")
    })
    ...
    test("Unicode fractions", () => {
        ...
        let result = replacementWrapper(matchList, "metric", "volume")
        expect(result).toEqual("<div kitchen-converted=\"true\">1/2 qt.</div>")
    })
    ...
    test("Slash fractions", () => {
        ...
        expect(result).toEqual("<div kitchen-converted=\"true\">3 and 1/3 tsps</div>")
    })
    ...
    test("Split element", () => {
        ...
        let result = replacementWrapper(matchList, "metric", "volume")
        expect(result).toEqual("<div><p kitchen-converted=\"true\">2/3 </p><h1 kitchen-converted=\"true\">tbsp</h1></div>")
    })
    ...
    test("Deeper node", () => {
        ...
        expect(result).toEqual("<div kitchen-converted=\"true\"><b>optional: </b>28 ozs</div>")
    })
    ...
    test("Temperature",() => {
        ...
        expect(result).toEqual("<div kitchen-converted=\"true\">212 farenheit</div>")
        ...
        expect(result).toEqual("<div kitchen-converted=\"true\">392 farenheit</div>")
    })
