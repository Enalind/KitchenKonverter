...
describe("Replacing US measurments",() => {
    ...
    test("Single element",() => {
        ...
        expect(result).toEqual("<div kitchen-converted=\"\">2 and 2/5 dl</div>")
        ...
        expect(result).toEqual("<div kitchen-converted=\"\">42 g</div>")
        ...
        expect(result).toEqual("<div kitchen-converted=\"\">1 and 2/5 l</div>")
    })
    ...
    test("Unicode fractions", () => {
        ...
        let result = replacementWrapper(matchList, "us", "volume")
        expect(result).toEqual("<div kitchen-converted=\"\">1 tbsp</div>")

        document.body.innerHTML = `<div>1½ cup</div>`
        matchList = [[document.querySelector("div"), ["1½ cup"]]]
        result = replacementWrapper(matchList, "us", "volume")
        expect(result).toEqual("<div kitchen-converted=\"\">3 and 3/5 dl</div>")
    })
    ...
    test("Split element", () => {
        ...
        let matchList = [[document.querySelector("div"), ["1 cup"]]]
        let result = replacementWrapper(matchList, "us", "volume")
        expect(result).toEqual("<div><p kitchen-converted=\"\">2 and 2/5 </p><h1 kitchen-converted=\"\">dl</h1></div>")
    })
    ...
    test("Deeper node", () => {
        ...
        expect(result).toEqual("<div kitchen-converted=\"\"><b>optional: </b>453 g</div>")
    })
    ...
    test("Temperature",() => {
        ...
        expect(result).toEqual("<div kitchen-converted=\"\">37 celsius</div>")
        ...
        expect(result).toEqual("<div kitchen-converted=\"\">93 celsius</div>")
    })
...
describe("Replacing metric measurments",() => {
    ...
    test("Single element",() => {
        ...
        expect(result).toEqual("<div kitchen-converted=\"\">3 and 1/3 fl oz</div>")
    })
    ...
    test("Unicode fractions", () => {
        ...
        let result = replacementWrapper(matchList, "metric", "volume")
        expect(result).toEqual("<div kitchen-converted=\"\">1/2 qt.</div>")
    })
    ...
    test("Slash fractions", () => {
        ...
        expect(result).toEqual("<div kitchen-converted=\"\">3 and 1/3 tsps</div>")
    })
    ...
    test("Split element", () => {
        ...
        let result = replacementWrapper(matchList, "metric", "volume")
        expect(result).toEqual("<div><p kitchen-converted=\"\">2/3 </p><h1 kitchen-converted=\"\">tbsp</h1></div>")
    })
    ...
    test("Deeper node", () => {
        ...
        expect(result).toEqual("<div kitchen-converted=\"\"><b>optional: </b>28 ozs</div>")
    })
    ...
    test("Temperature",() => {
        ...
        expect(result).toEqual("<div kitchen-converted=\"\">212 farenheit</div>")
        ...
        expect(result).toEqual("<div kitchen-converted=\"\">392 farenheit</div>")
    })
